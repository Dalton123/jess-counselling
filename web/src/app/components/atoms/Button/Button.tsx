...
export const Button = ({
  ...
  const baseClass = `relative z-1 w-fit btn animate-rotate-border flex cursor-pointer rounded-full bg-animated-conic-border p-0.5 text-slate-950 transition-all active:scale-[0.99] group hover:shadow-md hover:shadow-teal-500/50`;
